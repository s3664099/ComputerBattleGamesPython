...
def instructions():
	...
	print("the right one for it to have any effect. Code symbols for each Robot will")
	print("flash up on your screen. Quickly press the key with that symbol on it -")
	print("beware, some need the shift key too - and see how many Robot invaders")
	print("you can destroy.")
	print()
