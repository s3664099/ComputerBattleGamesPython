...
def instructions():
	...
	print("Secret Weapon")
	print("====== ======")
	print("Ifyou could destroy the main Robot Spare Parts Store, which lies underground")
	print("somewhere in the eastern wastes of the U.R.S., you could cripple the robot") 
	print("attack quite severely. You have a new secret weapon, as yet unknown to the")
	print("robots, which can cut silently through solid rock, vapourizing everything") 
	print("in its path. The Store is very cleverly concealed though. All you can do is")
	print("aim your weapon bUndly and hope you get somewhere near the target. Your computer")
	print("will ask you for a difficulty number (the smallest number allowed is 4) and")
	print("then ask for your guesses for the X and Y coordinates ofthe target. (Enter")
	print("these separately, pressing RETURN, NEWLINE or ENTER after each one.) For a")
	print("clue to the possible values of X and Y,lookcarefully at the program listing.")
	print()
